  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
          ...
          {privacyFeatures.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                className="flex gap-4 bg-card border border-border hover:border-blue-500/50 rounded-xl p-6 transition-all duration-300"
              >
                <motion.div
        ...
        >
          <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 dark:from-blue-900/30 dark:to-purple-900/30 border border-blue-500/30 rounded-xl p-8 text-center">
